...
- [ ] Add a visible warning banner when running in local mode so operators know cross-device sync is off.
- [ ] Add input validation/limits for team names and score bounds, including paste edge cases.
...
- [ ] Add game-day checklist to README (preflight test, URL parity check, score reset, stream scene check).
- [ ] Add simple manual test checklist covering iPhone + OBS/Browser Source behavior.
